...
public interface CalendarGroupMemberRepository extends JpaRepository<CalendarGroupMember, Long> {
    Optional<CalendarGroupMember> findByCalendarGroupAndMemberId(CalendarGroup calendarGroup, String memberId);
    List<CalendarGroupMember> findAllByMemberId(String memberId);
}
